...
export const SEED_STORE_RULES: StoreRule[] = [
  ...
  // === v21: Olive フレキシブルペイ 8% 対象店舗 ===
  // smbc-v の 7% タッチ決済 21+1 ルールに対し、Olive (フレキシブルペイ) は +1% 上乗せで 8%。
  // Olive 連携機能による「スマホタッチ決済 + Olive アカウント」の追加特典。
  // smbc-v rules と同じ validFrom (2023-04-03) で長期公式プログラム扱い。
  // pa-visa-touch は smbc-v と共通 (Olive も Visa ブランドカード)。
  //
  // 同店舗で smbc-v 7% と Olive 8% が併存するが、Calculator は cardId 単位で評価するため
  // 別カード扱いとなり問題なし (ユーザは Olive 保有 = 8% / smbc-v 保有 = 7%)。
  {
    id: "rule-olive-7eleven",
    cardId: "olive",
    storeId: "conv-7eleven",
    paymentAppId: "pa-visa-touch",
    validFrom: "2023-04-03",
    rate: 0.08,
    currencyId: "v-pt",
    notes: "Olive スマホタッチ決済 8% (smbc-v 7% + Olive 連携 +1%)",
  },
  {
    id: "rule-olive-lawson",
    cardId: "olive",
    storeId: "conv-lawson",
    paymentAppId: "pa-visa-touch",
    validFrom: "2023-04-03",
  ...
  },
  {
    ...
    rate: 0.08,
    currencyId: "v-pt",
    notes: "Olive スマホタッチ決済 8% (smbc-v 7% + Olive 連携 +1%、すかいらーくグループ)",
  },
  {
    id: "rule-olive-jonathan",
    cardId: "olive",
    storeId: "jonathan",
    paymentAppId: "pa-visa-touch",
    validFrom: "2023-04-03",
  ...
  },
  {
    ...
    rate: 0.08,
    currencyId: "v-pt",
    notes: "Olive スマホタッチ決済 8% (smbc-v 7% + Olive 連携 +1%、ゼンショーグループ)",
  },
  {
    id: "rule-olive-excelsior-cafe",
    cardId: "olive",
    storeId: "excelsior-cafe",
    paymentAppId: "pa-visa-touch",
    validFrom: "2023-04-03",
    rate: 0.08,
    currencyId: "v-pt",
    notes: "Olive スマホタッチ決済 8% (smbc-v 7% + Olive 連携 +1%、ドトール系列)",
  },
  {
    id: "rule-olive-kappa-sushi",
    cardId: "olive",
    storeId: "kappa-sushi",
    paymentAppId: "pa-visa-touch",
    validFrom: "2023-04-03",
...
export const SEED_LOYALTY_RULES: LoyaltyRule[] = [
  ...
  // ====== JRE POINT カード (駅ナカ加盟店、v21 追加) ======
  // 標準 200円(税抜)=1JREポイント = 0.5%。NewDays のオレンジ色店舗は 1% だが
  // 店舗バリエーション細則のため一律 0.5% に簡略化。実際の正確な還元は店舗別。
  {
    id: "loy-jre-newdays",
    storeId: "newdays",
    pointCardId: "jre-pointcard",
    rate: 0.005,
    notes: "200円(税抜)ごとに1ポイント。一部オレンジ色店舗は 100円1pt 1% (簡略化で 0.5%)",
  },
  {
    id: "loy-jre-kiosk",
    storeId: "kiosk",
  ...
  },
  {
    ...
    pointCardId: "jre-pointcard",
    rate: 0.005,
    notes: "acure (駅ナカ自販機) 200円ごとに1ポイント (JRE POINT 連携 Suica 支払い時)",
  },
  {
    id: "loy-jre-ecute",
    storeId: "ecute",
    pointCardId: "jre-pointcard",
    rate: 0.005,
    notes: "エキュート 各店、200円(税抜)ごとに1ポイント",
  },
  {
    id: "loy-jre-gransta",
    storeId: "gransta",
    pointCardId: "jre-pointcard",
    rate: 0.005,
    notes: "東京駅 グランスタ 各店、200円(税抜)ごとに1ポイント",
  },
  {
    id: "loy-jre-atre",
    storeId: "atre",
  ...
  },
  {
    ...
    pointCardId: "jre-pointcard",
    rate: 0.005,
    notes: "ニュウマン 各店、200円(税抜)ごとに1ポイント",
  },
];
